...
# If you are on CPU no need for these two lines, if you are on GPU uncomment them
...
def rotate(img, max_degrees=25):
    ...
    img = tfa.image.rotate(img, degrees*math.pi / 180, interpolation="BILINEAR") # this is in radians
    return img
